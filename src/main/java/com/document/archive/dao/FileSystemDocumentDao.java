package com.document.archive.dao;
...
import com.document.archive.service.Document;
import com.document.archive.service.DocumentMetadata;
...
public class FileSystemDocumentDao implements IDocumentDao {
	...
	public static final String POLLING_DATA_FILE_NAME = "polling.txt";
	 ...
	 * 
	 * @see com.document.archive.dao.IDocumentDao#insert(com.document.archive.service.Document)
	 */
	@Override
	 ...
	 * the parameter.
	 * 
	 * @see com.document.archive.dao.IDocumentDao#findByPersonNameDate(java.lang.String,
	 *      java.util.Date)
	 */
	@Override
	 ...
	 * 
	 * @see com.document.archive.dao.IDocumentDao#load(java.lang.String)
	 */
	@Override
	 ...
	 * @throws IOException
	 */
	public void updatePollingData(Document document) throws IOException {
		Properties props = document.createProperties();
		File f = new File(new File(DIRECTORY), POLLING_DATA_FILE_NAME);
		OutputStream out = new FileOutputStream(f);
		props.store(out, "Document meta data");
	}
